...
public class EmployeeManagementSys {
    public static void main(String[] args) {
        ...
        management.addEmployee(new Employee(1, "Pooja", "JavaDeveloper", 60000));
        management.addEmployee(new Employee(2, "Prajna", "ChatedAccountent", 80000));
        management.addEmployee(new Employee(3, "Priya", "Engineer", 50000));
